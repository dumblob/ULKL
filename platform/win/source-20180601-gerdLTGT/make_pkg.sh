...
#   Virtualbox - || -
# FIXME
#   msiexec /x c:\Windows\Installer\ba87.msi /l*v! c:\mylog00.txt
...
# FIXME
#     MSI (s) (18:64) [09:42:37:390]: Creating MSIHANDLE (2) of type 790536 for thread 4708
#     MSI (s) (18:C4) [09:42:37:390]: Invoking remote custom action. DLL: C:\WINDOWS\Installer\MSI2650.tmp, Entrypoint: CA04
#     MSI (s) (18:58) [09:42:37:390]: Generating random cookie.
#     MSI (s) (18:58) [09:42:37:390]: Created Custom Action Server with PID 8 (0x8).
#     MSI (s) (18:54) [09:42:37:421]: Running as a service.
#     MSI (s) (18:54) [09:42:37:421]: Hello, I'm your 32bit Impersonated custom action server.
#     CustomAction RemoveKeyboardFromLangBar.7A997F8B33EC4BF79A5E859E1F48AD36 returned actual error code 1603 (note this may not be 100% accurate if translation happened inside sandbox)
#     MSI (s) (18:C4) [09:42:37:421]: Closing MSIHANDLE (2) of type 790536 for thread 4708
#     Aktion beendet um 09:42:37: InstallFinalize. Rückgabewert 3.
#     MSI (s) (18:64) [09:42:37:436]: Note: 1: 2265 2:  3: -2147287035 
#     MSI (s) (18:64) [09:42:37:436]: User policy value 'DisableRollback' is 0
#     MSI (s) (18:64) [09:42:37:436]: Machine policy value 'DisableRollback' is 0
...
#      fi
  ...
  (
    ...
    # FIXME -DSTD_CALL
    "$msklc\\bin\\i386\\rc.exe" -i "$msklc\\inc" -DCONDITION_HANDLING=1 -DNT_UP=1 -DNT_INST= -DWIN32=1 -D_NT1X_=1 -DWINNT=1 -D_WIN32_WINNT=0x0500 -DWINVER=0x0400 -D_WIN32_IE=0x0400 -DWIN32_LEAN_AND_MEAN=1 -DDEVL=1 -DFPO=1 -DNDEBUG -l "$localeid" -fo "${TEMP_WIN_PREFIX}.res" "${kbdname}.rc"

    # FIXME -Gz (x86 only)
    #   -DSTD_CALL
    # FIXME -EHs-c-
    "$p\\cl.exe" -nologo -DNOGDICAPMASKS -DNOWINMESSAGES -DNOWINSTYLES -DNOSYSMETRICS -DNOMENUS -DNOICONS -DNOSYSCOMMANDS -DNORASTEROPS -DNOSHOWWINDOW -DOEMRESOURCE -DNOATOM -DNOCLIPBOARD -DNOCOLOR -DNOCTLMGR -DNODRAWTEXT -DNOGDI -DNOKERNEL -DNONLS -DNOMB -DNOMEMMGR -DNOMETAFILE -DNOMINMAX -DNOMSG -DNOOPENFILE -DNOSCROLL -DNOSERVICE -DNOSOUND -DNOTEXTMETRIC -DNOWINOFFSETS -DNOWH -DNOCOMM -DNOKANJI -DNOHELP -DNOPROFILER -DNODEFERWINDOWPOS -DNOMCX -DWIN32_LEAN_AND_MEAN -DRoster -D_WIN32_WINNT=0x0500 $defwow64 -DWINVER=0x0400 -D_WIN32_IE=0x0400 -MD -c -Zp8 -Gy -W3 -WX -EHsc -GR- -GF -Z7 -Ox "-I$msklc\\inc" -Fo"${TEMP_WIN_PREFIX}.obj" "${kbdname}.c"
